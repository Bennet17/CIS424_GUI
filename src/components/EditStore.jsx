...
const EditStore = (store) => {
  ...
  const toggleAbility = (event) => {
    ...
    if (store.store.enabled == true) {
      ...
      if (store.store.opened == true) {
        setResult(
          "You cannot deactivate an open store. Please close day and try again."
        ); //alert user
      } else {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      ...
      .then((response) => {
        if (
          response.data.Message === "Store and Totals updated successfully."
        ) {
          //successful edit
          closeModal();
          window.location.reload(); // This will refresh the page
  ...
  return (
    <div className="relative ml-5">
      ...
      {isOpen && (
        <div className="fixed text-navy-gray z-50 inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-white p-8 rounded shadow-md w-auto">
            ...
            <h2 className="text-2xl font-bold mb-2">
              Edit Store Information: {store.store.location}{" "}
            </h2>
            ...
            >
              <div className="grid grid-cols-3 gap-4">
                <div className="mb-2 col-span-1">
                  <label
                    htmlFor="location"
                    className="block text-navy-gray font-bold mb-2"
                  >
                    Store Name:
                  </label>
                  <input
                ...
                <Button
                  ...
                  className={
                    store.store.enabled
                      ...
                      : "p-button-success p-button-raised"
                  }
                  rounded
                  size="medium"
