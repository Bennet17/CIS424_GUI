                    ...
                    <form onKeyDown={PreventKeyDown} onSubmit={e => CurrentIsPastThreshold() == 0 ? Submit(e) : setShowConfirm(true)}>
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="3"><p className="rounded-md py-1 cursor-pointer w-full mb-4 text-center hover:bg-nav-bg bg-white text-xl" onClick={ToggleExtraChange}>{showExtraChangeTxt}</p></td>
                                </tr>
                                <tr>
                                    <td>
                                        <button type="submit" value="submit" min="0" className="flex w-full justify-center rounded-full bg-button-blue px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-button-blue-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-button-blue">Close</button>
                                    </td>
                                    <td>
                    ...
                    <div>
                        <label> Expected Total:
                            <input 
                                ...
                                className={`rounded-md box-border text-center mb-4 ml-6 mr-12 w-24 float-right border-border-color border-2 ${currentPosIndex === 0 ? "bg-nav-bg" : "bg-white"} `} 
                                type="text" 
                            />
                        </label>
                    </div>
