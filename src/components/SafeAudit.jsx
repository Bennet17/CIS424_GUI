...
const SafeAuditPage = () => {
        ...
        .then((response) => {
          ...
          if (safeObject) {
            ...
            if (safeObject.opened) {
              ...
              toast.warning(
                "Safe is not open. Expected amount cannot be retrieved."
              );
            }
          } else {
  ...
  function CheckFields() {
    ...
    if (safeStatus === false) {
      toast.warning(
        "Safe is not open. Please open the safe to count the amount."
      );
      return true;
      ...
      document
        ...
        .classList.add("safe-amount-input-error");
      ...
      document
        .getElementById("currentAmount_input")
        .classList.add("safe-amount-input");
  ...
  const HandleSubmit = async (event) => {
    ...
    if (
      ...
      parseFloat(formData.expectedAmount) - 2
    ) {
      if (
        !window.confirm(
          "The actual amount is less than the expected amount. Do you want to proceed?"
        )
      )
        return;
    }
    ...
    if (
      ...
      if (
        !window.confirm(
          "The actual amount is more than the expected amount. Do you want to proceed?"
        )
      )
        return;
    }
                ...
                <tr>
                  <td>
                    ...
                    <div className="label-above-select">
                      <strong>
                        <label htmlFor="expectedAmount_input">
                          Expected Safe Total:
                        </label>
                      </strong>
                      <CurrencyInput
                  ...
                  <td>
                    ...
                    <div className="label-above-select">
                      <strong>
                        <label htmlFor="currentAmount_input">
                          Actual Safe Count:
                        </label>
                      </strong>
                      <CurrencyInput
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        className={`denomination-expected ${
                          parseInt(formData.expectedHundred) > 0
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedQuarterRoll) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedQuarter) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedFifty) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedDimeRoll) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedDime) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedTwenty) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedNickelRoll) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedNickel) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedTen) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedPennyRoll) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedPenny) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedFive) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        readOnly={true}
                        className={`denomination-expected ${
                          parseInt(formData.expectedOne) > 0
                            ? "denomination-expected-valid"
                            : ""
                        }`}
