...
const VarianceAuditPage = () =>{
    ...
    const VarianceAuditURL = "https://cis424-rest-api.azurewebsites.net/SVSU_CIS424/VarianceAudit";
    ...
    useEffect(() => {
        UpdateInputDates();
        setTotal(cashTendered + cashBuys + pettyCash + mastercard + visa + amex + discover + debit + other);
    }, [cashTendered, cashBuys, pettyCash, mastercard, visa, amex, discover, debit, other, UpdateInputDates]);
    ...
    async function SubmitAudit(request) {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setCashOverShort(FormatCurrency(parseFloat(response.data.cashVariance).toFixed(2)));
                setCCOverShort(FormatCurrency(parseFloat(response.data.creditVariance).toFixed(2)));
                setTotalOverShort(FormatCurrency(parseFloat(response.data.totalVariance).toFixed(2)));
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div className="label-above-select">
                                            <strong>
                                                <label htmlFor="totalOverShort">Total Over/Short:</label>
                                            </strong>
                                            <input
                                                type="text"
                                                id="totalOverShort"
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            {/* Cash Tendered */}
                                            <td>
                                                <label htmlFor="cashTendered_input">Cash Tendered</label>
                                                <InputNumber
