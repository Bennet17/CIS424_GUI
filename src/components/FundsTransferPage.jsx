...
const FundsTransferPage = () => {
  ...
  const statusClass = status.startsWith("Successfully")
    ? successClass
    : errorClass;
  ...
  return (
    <div>
      <SideBar currentPage={transferFundsPageName} />
      <HorizontalNav />
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <button
                    type="reset"
                    className="bg-main-color hover:bg-hover-color text-white font-bold py-2 px-10 rounded mt-4 ml-6 "
                  >
                    Cancel
                  </button>
                  <button
