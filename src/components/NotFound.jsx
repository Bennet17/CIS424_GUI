...
const HomePage = () => {
  ...
  return (
    <div className="mt-48 grid grid-cols-1 grid-rows-2 gap-1 content-center">
        ...
        <p className="text-center w-full mt-32 text-2xl">OOPSIE WOOPSIE!! Uwu We make a fucky wucky!! A wittle fucko boingo!
        The code monkeys at our headquarters are working VEWY HAWD to fix this!</p>
