  ...
  return (
    <div className="flex min-h-screen bg-custom-accent">
      ...
      <div className="flex flex-col w-full">
        <HorizotalNav />
        <h2 className="text-xl font-bold text-navy-gray mt-8 px-6 ">POS Registers at Plato's Closet: {curStoreName}</h2>
        <div className="flex flex-col items-center justify-center px-6"> {/* Added items-center justify-center */}
          <div className="w-full max-w-screen-lg"> {/* Limiting width to maintain responsiveness */}
            <div className="flex px-6 justify-center"> {/* Centering horizontally */}
              <div style={{ width: '90%' }}>
                <POSTable />
              </div>
            </div>
